...
echo ''
echo ''
echo -e $red      "FB: MNTZER-ANWER       TELEGRAM: MNTZER_18        INSTA: 313.JS"
echo ""
toilet " MN.TZER" | lolcat
echo ''
echo -e $green"                    <<<$red The Script By: MNTZER-ANWER $green>>>"
...
toilet "EXIT" | lolcat
echo ""
echo -e $red "   TELEGRAM: $green  MNTZER_18"
echo -e $red "   FACEBOOK: $green  MNTZER.ANWER"
echo -e $red "   INSTAGRA: $green  313.JS"
echo -e $red "   MY CHHENL IN TELEGRAM : $green  AZLA0"
echo ""
echo ""
exit
fi
...
echo
echo -e $red
echo -e       "FB: MNTZER.ANWER18       TELEGRAM: MNTZER_18        INSTA: 313.JS"
...
echo ""
echo -e $red"{ "$blue"2 "$red"}" $green"Sleep" $blue">>>>>>" $green"{ Sleep Android + kay 31318 }"
echo ""
...
clear
figlet "TOOLS HACKER"
echo -e $blue "                   THE TOOL BY MNTZER ANWER"
echo -e $blue "                    TELEGRAM MNTZER_18"
...
echo -e $green   "<-------------( ######M*N*T*Z*E*R#A*N*W*E*R###### )------------->"
sleep 0.1
echo -e $green   "|                                                               |"
sleep 0.1
echo -e $green   "|                                                               |"
sleep 0.1
echo -e $green   "|     $white  Word        $red  By: MNTZER-ANWER             $white list       $green |"
sleep 0.1
echo -e $green   "|                                                               |"
sleep 0.1
echo -e $green   "|                                                               |"
...
echo -e $green
read -p "Characters Numbers Symbols: " MNTZER
echo
echo
echo -e $red "                START WORDLIST"
echo -e $red "                 PLEASE WAIT"
sleep 3
wordlist -m $smole -M $smole -o wordlist.txt $MNTZER
clear
echo
echo
echo
...
echo '-o /storage/emulated/0/MNTZERANWER/%(title)s.%(ext)s' >> ~/.config/youtube-dl/config
...
echo -e $red "         The Script By: MNTZER-ANWER"
...
echo ""
echo -e $green "Done........"
echo -e $green "Save to /storage/emulated/0/MNTZERANWER"
sleep 6
bash MNTZER.sh
fi
######################
...
echo "clear" >> bash.bashrc
echo 'echo' >> bash.bashrc
echo 'echo -e $red      "FB: MNTZER.ANWER18       TELEGRAM: MNTZER_18        INSTA: 313.JS"' >> bash.bashrc
echo 'echo""'
echo 'toilet " MN.TZER" | lolcat' >> bash.bashrc
echo 'echo""' bash.bashrc
echo 'echo -e $green"                    <<<$red The Script By: MNTZER-ANWER $green>>>"' >> bash.bashrc
echo 'echo' >> bash.bashrc
echo 'PS1="\[\033[01;32m\]MNTZER=>\[\033[01;36m\] "' >> bash.bashrc
...
echo "clear" >> bash.bashrc
echo 'echo' >> bash.bashrc
echo 'echo -e $red      "FB: MNTZER.ANWER18       TELEGRAM: MNTZER_18        INSTA: .313JS"' >> bash.bashrc
echo 'toilet " MN.TZER" | lolcat' >> bash.bashrc
echo 'echo""' >> bash.bashrc
echo 'echo -e $green"                    <<<$red The Script By: MNTZER-ANWER $green>>>"' >> bash.bashrc
echo 'echo' >> bash.bashrc
...
then
clear
figlet -f slant "HASH-MNTZER" | lolcat
echo -e $red "               @Code By: "$green"MNTZER-ANWER"
echo -e $red "              MY CHENL IN TELEGRAM:  "$green"AZLA0"
echo -e $red "               Facebook: "$green"MNTZER.ANWER18"
echo -e $red "               Tweter  : "$green"MNTZER.ANWER18"
echo -e $red "               Telegram: "$green"MNTZER_18"
echo
echo
